...
// Project 1 = true (Column Asm), Project 2 = false (Roof Asm)
let proj = true;
...
const stepList = proj ? {
  ...
  5:  {text: "Now, adjust the torque wrench to 10 pounds per feet and tight the bolts to a quarter of a turn.", url: "https://res.cloudinary.com/djpg8rwkv/image/upload/v1674842338/asm_1/A1S5_dvkbkm.png"},
  ...
  4: {text: "Connect P2 and PS3 with two bolts half an inch in diameter. Put a washer on both sides of the bolt and tight by hand", url: "https://res.cloudinary.com/djpg8rwkv/image/upload/v1674842347/asm_2/A2S4_tf8fpv.png"},
